...
export const emspNetworkNameEnums = ['Internal eMSP', 'Green Flux eMSP', 'EVOASIS eMSP', 'exploren eMSP', 'Incar eMSP'];
export const cpoNetworkNameEnums = ['Internal CPO', 'Green Flux CPO', 'EVOASIS CPO', 'exploren CPO', 'Incar CPO'];
...
export const networkStatusEnums = ['not activated', 'available', 'abnormal'];
