        ...
        <v-container>
          ...
          <v-card-text>
            ...
            <v-row>
              ...
              <v-col cols="12" sm="6" md="4">
                <v-text-field label="Legal last name*" persistent-hint required />
              </v-col>
              <v-col cols="12">
              ...
              <v-col cols="12" sm="6">
                <v-autocomplete :items="[
                  ...
                  'Coding',
                  'Basejump',
                ]" label="Interests" multiple density="comfortable" variant="outlined" />
              </v-col>
            </v-row>
          ...
          <v-card-actions>
            ...
            <v-btn color="success" @click="dialog = false" variant="tonal" class="px-4 ">
              Save
            </v-btn>
          </v-card-actions>
        </v-container>
